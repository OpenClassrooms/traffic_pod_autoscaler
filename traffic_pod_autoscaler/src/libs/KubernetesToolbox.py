...
class KubernetesToolbox(object):
    ...
    def create_namespaced_config_map(self, _namespace, _config_map_name):
        ...
        _body = {
            "metadata": {
                ...
                "labels": {"app.kubernetes.io/name": _config_map_name},
            }
        }

        with client.ApiClient(self._configuration) as api_client:
            api_instance = client.CoreV1Api(api_client)
            api_response = api_instance.create_namespaced_config_map(namespace=_namespace, body=_body)
    ...
    def get_deployment_annotation(self, _namespace, _deployment_name, _annotation):
        ...
        with client.ApiClient(self._configuration) as api_client:
            ...
            api_response = api_instance.read_namespaced_deployment(name=_deployment_name, namespace=_namespace)
    ...
    def get_replica_number(self, _namespace, _label_selector):
        _logger.debug("START")
        try:
            _replica_set_parents = self.get_replica_set_parents(_namespace, _label_selector)
            ...
            _custom_object_kind_plural = self.get_kind_plural(_replica_set_parents.kind)
    ...
    def update_deployment_annotation(self, _namespace, _deployment_name, _annotation, _annotation_value):
        ...
        with client.ApiClient(self._configuration) as api_client:
            ...
            _body = {"metadata": {"annotations": {f"{_annotation}": _annotation_value}}}
    ...
    def get_config_map_annotation(self, _namespace, _config_map_name, _annotation):
        ...
        try:
            with client.ApiClient(self._configuration) as api_client:
                api_instance = client.CoreV1Api(api_client)
                api_response = api_instance.read_namespaced_config_map(name=_config_map_name, namespace=_namespace)
    ...
    def patch_namespaced_custom_object(
        self, _namespace, _group, _version, _custom_object_name, _custom_object_kind_plural, _body
    ):
        ...
        with client.ApiClient(self._configuration) as api_client:
            ...
            try:
                ...
                api_response = api_instance.patch_namespaced_custom_object(
                    ...
                    plural=_custom_object_kind_plural,
                    body=_body,
                )
    ...
    def get_namespaced_custom_object(
        self, _namespace, _group, _version, _custom_object_name, _custom_object_kind_plural
    ):
    ...
    def get_replica_set_name(self, _namespace, _label_selector):
        _logger.debug("START")
        _replica_set_name_last = self.get_replica_set_field(_namespace, "name", _label_selector)
        return _replica_set_name_last

    def get_replica_set_parents(self, _namespace, _label_selector):
        _logger.debug("START")
        _replica_set_parents = self.get_replica_set_field(_namespace, "parents", _label_selector)
    ...
    def get_replica_set_field(self, _namespace, _field, _label_selector="", _limit=1):
        ...
        with client.ApiClient(self._configuration) as api_client:
            ...
            _logger.trace(f"find replica_set_name api_response: {api_response}")
    ...
    def check_endpoint_available(self, _namespace, _endpoint_name):
        ...
        with client.ApiClient(self._configuration) as api_client:
            api_instance = client.CoreV1Api(api_client)
            api_response = api_instance.read_namespaced_endpoints(name=_endpoint_name, namespace=_namespace)
